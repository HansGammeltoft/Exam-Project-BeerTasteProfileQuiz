    ...
    <section class="test-wrapper">
        ...
        <div id="button-form-wrapper">
            ...
            <form class="question-answers" id="questions-6-answers">
                ...
                <label for="answer-option3" class="answers">
                    <input type="radio" id="answer-option3" name="answer-options">
                    <div class="answer-border">
                        <img src="./images/5.png" alt="Pink">
                        <p>Kaffe</p>
                    </div>
                </label>
                <label for="answer-option4" class="answers">
                    <input type="radio" id="answer-option4" name="answer-options">
                    <div class="answer-border">
                        <img src="./images/5.png" alt="Pink">
                        <p>Tequila</p>
                    </div>
                </label>
                <label for="answer-option5" class="answers">
                    <input type="radio" id="answer-option5" name="answer-options">
                    <div class="answer-border">
                        <img src="./images/5.png" alt="Pink">
                        <p>Kaffe</p>
                    </div>
                </label>
                <label for="answer-option6" class="answers">
                    <input type="radio" id="answer-option6" name="answer-options">
                    <div class="answer-border">
                        <img src="./images/5.png" alt="Pink">
                        <p>Tequila</p>
                    </div>
            ...
            <button class="quiz-button quiz-button2 quiz-buttonx6">Næste</button>
        </div>
